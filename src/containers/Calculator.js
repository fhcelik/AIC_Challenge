...
import { branch, compose, lifecycle, pure, renderComponent, withHandlers, withProps } from 'recompose';
...
export default compose(
  ...
  branch(({brokenId, id}) => brokenId === id, compose(
    withProps({message: "Invalid formula"}),
    renderComponent(ErrorCatch),
  )),
  connect(
    calculatorPropsSelector,
    {
