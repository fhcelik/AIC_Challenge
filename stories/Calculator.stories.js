...
storiesOf('Calculator', module)
  ...
  .add('quadratic from state', () => <Calculator id={quadraticCalcId} />)
  .add('mudweight ft from state', () => <Calculator id={mwCalcId} />)
  .add('mudweight m from state', () => <Calculator id={mwMCalcId} />)
  .add('errors', () => <Calculator id={errCalcId} />)
